...
using KnifeSlicer.UnitySpriteCutter.Tools;
using GameObjectCreationMode = KnifeSlicer.UnitySpriteCutter.SpriteCutterInput.GameObjectCreationMode;

namespace KnifeSlicer.UnitySpriteCutter {
